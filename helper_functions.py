...
def create_config(output_dir):
    DOMAIN_TYPE = (
        "telephonic"  # Can be meeting, telephonic, or general based on domain type of the audio file
        # "meeting" yaml file mismatches with the telephonic msdd model, use telephonic instead
    )
    ...
    meta = {
        ...
        "label": "infer",
        "text": "-",
        "num_speakers": 2,  # force to 2 speakers
        "rttm_filepath": None,
        "uem_filepath": None,
    }
    ...
    config.diarizer.clustering.parameters.oracle_num_speakers = True    # force to 2 speakers
